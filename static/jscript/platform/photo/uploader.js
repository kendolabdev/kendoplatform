...
define(['jquery','underscore','jquery-ext'], function () {
     ...
     */
    $(document).on('click', '[data-toggle="btn-album-upload"]', function (evt) {
        var ele = $(evt.currentTarget),
            file = $(ele.data('target'));

        file.trigger('click');
    }).on('click', '[data-toggle="btn-album-switch-mode"]', function (evt) {
        var btn = $(evt.currentTarget),
            form = $('.photo-album-switch-form'),
