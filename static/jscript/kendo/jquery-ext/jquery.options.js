...
define(['jquery','underscore'],function(){
    ...
    _Dialog.prototype.updateDialogPositionForFlying = function () {
        ...
        if (isLeft) {
            left = offset.left - 12;
            tailPos.left = Math.ceil(this.element.outerWidth() / 2 - 10 + 12);
        } else {
            left = offset.left + this.element.outerWidth() + 12;
            tailPos.right = Math.ceil(this.element.outerWidth() / 2 - 10 + 12);
        }
