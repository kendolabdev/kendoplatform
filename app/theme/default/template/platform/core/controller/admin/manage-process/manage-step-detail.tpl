...
<div class="btn-toolbar">
    <div class="btn-group">
        ...
        <a class="btn btn-sm btn-default"
           href="<?php echo $this->helper()->url('admin', array('any'=> 'core/manage-process/steps','contentType'=>$step->getContentType(), 'actionType'=>$step->getActionType()));?>">
            All Steps
        </a>
        <a class="btn btn-sm btn-default"
           href="<?php echo $this->helper()->url('admin', array('any'=> 'core/manage-process/add-section','stepId'=> $stepId));?>">
            Add Section
        </a>
        <a class="btn btn-sm btn-default"
           href="<?php echo $this->helper()->url('admin', array('any'=> 'core/manage-process/add-field','stepId'=> $stepId));?>">
            Add Field
        </a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr class="bg-info">
            ...
            <td>
                ...
                array('any'=>'core/manage-process/edit-section', 'sectionId'=> $section->getId())); ?>
                <span>&middot;</span>
                <?php echo $this->helper()->link('Delete', array(), 'admin',
                array('any'=>'core/manage-process/delete-section', 'sectionId'=> $section->getId())); ?>
            </td>
        </tr>
        ...
        <tr class="">
            ...
            <td>
                ...
                array('any'=>'core/manage-process/edit-field-style', 'fieldId'=> $field->getId())); ?>
                <span>&middot;</span>
                <?php echo $this->helper()->textLink('core.edit', array(), 'admin',
                array('any'=>'core/manage-process/edit-field', 'fieldId'=> $field->getId())); ?>
                <span>&middot;</span>
                <?php echo $this->helper()->textLink('core.rules', array(), 'admin',
                array('any'=>'core/manage-process/list-field-rules', 'fieldId'=> $field->getId())); ?>
                <span>&middot;</span>
                <?php echo $this->helper()->textLink('core.translation', array(), 'admin',
                array('any'=>'core/i18n/phrases', 'q'=> $field->getTitle())); ?>
                <span>&middot;</span>
                <?php echo $this->helper()->textLink('core.delete', array(), 'admin',
                array('any'=>'core/manage-process/delete-field', 'fieldId'=> $field->getId())); ?>
            </td>
        </tr>
        <?php endforeach; ?>
        <?php endforeach; ?>
