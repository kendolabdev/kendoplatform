    ...
    <div class="row page-note">
        <div class="col-md-6 col-sm-6">
            <div class="btn-group">
                <a class="btn btn-sm btn-default"
                   href="<?php echo $profile->toHref(array('any'=>'photos'));?>">Photos</a>
                <a class="btn btn-sm btn-default"
                   href="<?php echo $profile->toHref(array('any'=>'albums'));?>">Albums</a>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 text-right">
            ...
            <input id="upload-new-album-photo" type="file" class="hidden fc-att-photo-input-add" name="photos[]"
                   ...
                   data-modal="ajax/platform/photo/photo/upload-photo-dialog?albumId=0&mode=1&context=profile_photos&parentId=<?php echo $profile->getId();?>&parentType=<?php echo $profile->getType();?>"
            ...
            <input id="upload-album-photo" type="file" class="hidden fc-att-photo-input-add" name="photos[]"
                   ...
                   data-url="ajax/platform/photo/upload/temp"
                   ride="ajaxUploadHandler"
                   data-modal="ajax/platform/photo/photo/upload-photo-dialog?albumId=0&mode=0&context=profile_photos&parentId=<?php echo $profile->getId();?>&parentType=<?php echo $profile->getType();?>"
                   data-preview="#upload-album-preview"/>
        </div>
    </div>
</div>
