            ...
            <span class="card-img" style="background-image: url(<?php echo $item->getPhoto('440');?>)">
                ...
                <div class="card-body">
                    <div class="card-body-stage">
                        <a class="profile" href="<?php echo $album->toHref();?>" target="_blank">
                            <?php echo $album->getTitle();?>
                        </a>

                        <div class="card-extra">
                            <div class="card-extra-stage separate-cmd">
                                <span> by <?php echo $this->helper()->toLink($item->getPoster()); ?></span>
                                <span><?php echo $this->helper()->date($item->getCreatedAt());?></span>
                            </div>
                        </div>
                        <p>
