...
<div class="btn-toolbar">
    <div class="btn-group">
        ...
        <a class="btn btn-sm btn-default"
           href="<?php echo $this->helper()->url('admin', array('stuff'=> 'core/manage-process/add-step','contentType'=> $contentType, 'actionType'=>$actionType));?>">
            Add Step
        </a>
    </div>
</div>
...
<table class="table">
    ...
    <tr>
        ...
        <td>
            ...
            array('stuff'=>'core/manage-process/edit-step', 'stepId'=>$item->getId())); ?>
            <span>&middot;</span>
            <?php echo $this->helper()->textLink('core.sections',array(),'admin',
            array('stuff'=>'core/manage-process/step-detail', 'stepId'=>$item->getId())); ?>
        </td>
    </tr>
    <?php endforeach; ?>
    </tbody>
