    ...
    <div class="card-stage">
        <div class="card-content">
            ...
            <div class="card-extra separate-cmd">
                <a class="text-muted"
                   href="<?php echo $this->helper()->url('admin',['stuff'=>'help/category/edit', 'id'=>$item->getId()]);?>">Edit Category</a>

                <a class="text-muted"
                   href="<?php echo $this->helper()->url('admin',['stuff'=>'help/category/delete', 'id'=>$item->getId()]);?>">Delete Category</a>
            </div>
