                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Home Shop</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Home Portfolio</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Home Blog</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Home Magazine</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Home Parallax</a></li>
                        </ul>
                    ...
                    <div class="col-md-4">
                        <h4 class="letter-spacing-1">PORTFOLIO</h4>
                        <ul class="list-unstyled">
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Portfolio 2 Columns</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Portfolio 3 Columns</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Portfolio 4 Columns</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Single Basic</a></li>
                            <li><a class="block" href="#"><i class="fa fa-angle-right"></i> Single Full Slider</a></li>
                        </ul>
                    </div>
