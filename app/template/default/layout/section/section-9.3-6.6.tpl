<div id="<?php echo !empty($section_id)?$section_id:'';?>" class="section section-main" data-render="section-9.3-6.6" data-template="default">
    ...
    <div class="row">
        <div class="col-md-9 col-sm-9">
            <div class="row">
                ...
                <!--left-->
                <div class="col-lg-6 col-sm-6 col-md-6 location node _left" data-location="left">
                    <?php echo !empty($left)?$left: ''; ?>
                </div>
                <!--main-->
                <div class="col-lg-6 col-sm-6 col-md-6 location node _main" data-location="main">
