...
use Attribute\Form\AttributeInternalForm;
use Attribute\Model\AttributeField;
use Attribute\Model\AttributeFieldMap;
use Attribute\Model\AttributeOption;
use Attribute\Model\AttributePlugin;
use Attribute\Model\AttributeSection;
use Attribute\Model\AttributeSectionMap;
use Attribute\Model\AttributeCatalog;
...
class AttributeService
{
    ...
    /**
     * @param HasAttribute|Poster $item
     * @param                     $data
     */
     ...
     * @param $catalogId
     *
     * @return \Attribute\Form\AttributeInternalForm
     */
     ...
     * @param HasAttribute $subject
     *
     * @return \Attribute\Form\AttributeCustomForm
     */
