...
use Picaso\Storage\LocalStorage;
use Picaso\Storage\PathGeneratorByDate;
use Picaso\Storage\PathGeneratorInterface;
use Picaso\Storage\StorageInterface;
use Picaso\Storage\StorageManagerInterface;
use Storage\Model\Storage;
use Storage\Model\StorageFile;
use Storage\Model\StorageFileTmp;
...
class StorageService implements StorageManagerInterface
{
    ...
    /**
     * @var \Picaso\Storage\PathGeneratorInterface
     */
     ...
     * @param string $maker
     *
     * @return \Storage\Model\StorageFile
     */
    ...
    public function saveAllProcessedPhoto($data, $uploadTemporaryDir, StorageInterface $storage = null)
    {
        ...
        foreach ($data as $item) {
            ...
            if (true) {
                ...
                $origin->setCreatedAt(PICASO_DATE_TIME);
                $origin->save();
            ...
            if (!empty($item['children'])) {
                foreach ($item['children'] as $child) {
                    ...
                    $file->setCreatedAt(PICASO_DATE_TIME);
     ...
     * @param \Picaso\Storage\StorageInterface|null $storage
     *
     * @return array
     */
