...
/**
 * Class CoreProfileValueText
 * @package Core\Model
 */
class CoreProfileValueText extends Model{
    // PUT YOUR CODE HERE
    ...
    /**
     * @return \Core\Model\CoreProfileValueTextTable
     */
    public function table(){
        return \App::table('core.core_profile_value_text');
    }
    //END_TABLE_GENERATOR
}