...
class ProfileService
{
     ...
     * @return array
     */
    public function loadValuesForEdit(Poster $profile, $names = null)
    {
     ...
     * @return array
     */
    public function updateValues(Poster $profile, $data)
    {
        /**
     ...
     * @return array
     */
    public function getAbout(Poster $profile)
    {
     ...
     * @return array
     */
    public function loadValuesForRender(Poster $profile, $names = null)
    {
        $fields = $this->getProfileFields($profile->getType());
