<?php
/**
 * Generate by CodeGenerator\DbTable for table `picaso_notification`
 */
...
class Notification extends Model
{
    ...
    /**
     * @return \Picaso\Content\Atom
     */
    public function getAtom()
    {
        return \App::find($this->getAtomType(), $this->getAtomId());
    }
    ...
    /**
     * @return \Notification\Model\NotificationTable
     */
