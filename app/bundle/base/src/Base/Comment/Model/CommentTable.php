...
class CommentTable extends DbTable
{
    ...
    /**
     * @see `picaso_base_comment`
     * @var string
     */
    protected $class =  '\Base\Comment\Model\Comment';

    /**
     * @var string
     */
    protected $name =  'base_comment';
     ...
     * @return \Base\Comment\Model\Comment
     */
