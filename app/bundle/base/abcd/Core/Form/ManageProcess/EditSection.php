 ...
 */
class EditSection extends Form
{
    ...
    protected function init()
    {
        ...
        $this->setTitle('manage_process_form_section.form_title');

        $this->setNote('manage_process_form_section.form_note');
        ...
        $this->addElement([
            ...
            'required' => true,
            'options'  => \App::service('core.process')->getStepOptions($this->getContentType(), $this->getActionType()),
        ]);
