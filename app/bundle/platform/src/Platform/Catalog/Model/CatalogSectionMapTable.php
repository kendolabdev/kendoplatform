...
/**
 * Class CatalogSectionMapTable
 * @package Platform\Catalog\Model
 */
class CatalogSectionMapTable extends DbTable{
    // PUT YOUR CODE HERE
     ...
     * @var string
     */
    protected $class =  '\Platform\Catalog\Model\CatalogSectionMap';
     ...
     * @return \Platform\Catalog\Model\CatalogSectionMap
     */
