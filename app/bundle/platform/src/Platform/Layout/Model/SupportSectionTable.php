...
/**
 * Class SupportSectionTable
 * @package Platform\Layout\Model
 */
class SupportSectionTable extends DbTable{
    // PUT YOUR CODE HERE
     ...
     * @var string
     */
    protected $class =  '\Platform\Layout\Model\SupportSection';
     ...
     * @return \Platform\Layout\Model\SupportSection
     */
