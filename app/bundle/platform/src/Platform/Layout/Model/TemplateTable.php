<?php
/**
 * Generate by CodeGenerator\DbTable for table `picaso_platform_layout_template`
 */
 ...
 */
class TemplateTable extends DbTable{
    // PUT YOUR CODE HERE
     ...
     * @var string
     */
    protected $class =  '\Platform\Layout\Model\Template';
     ...
     * @return \Platform\Layout\Model\Template
     */
