<?php
/**
 * Generate by CodeGenerator\DbTable for table `kendo_layout_support_block`
 */
...
/**
 * Class Platform\LayoutSupportBlockTable
 *
...
class LayoutSupportBlockTable extends DbTable
{
     ...
     * @var string
     */
    protected $class = '\Platform\Layout\Model\LayoutSupportBlock';
     ...
     * @var array
     */
    protected $primary = ['support_block_id' => 1];
