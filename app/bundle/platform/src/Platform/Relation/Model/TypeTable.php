<?php
/**
 * Generate by CodeGenerator\DbTable for table `picaso_platform_relation_type`
 */
...
class TypeTable extends DbTable{
     ...
     * @var string
     */
    protected $class =  '\Platform\Relation\Model\Type';
     ...
     * @return \Platform\Relation\Model\Type
     */
