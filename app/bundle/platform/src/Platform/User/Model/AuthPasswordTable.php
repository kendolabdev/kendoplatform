<?php
/**
 * Generate by CodeGenerator\DbTable for table `picaso_platform_user_auth_password`
 */
...
/**
 * Class AuthPasswordTable
 * @package Platform\User\Model
 */
class AuthPasswordTable extends DbTable{
    // PUT YOUR CODE HERE
     ...
     * @var string
     */
    protected $class =  '\Platform\User\Model\AuthPassword';
     ...
     * @return \Platform\User\Model\AuthPassword
     */
