<?php
/**
 * Generate by CodeGenerator\DbTable for table `picaso_platform_core_profile_value_string`
 */
...
/**
 * Class ProfileValueString
 * @package Platform\Core\Model
 */
class ProfileValueString extends Model{
    // PUT YOUR CODE HERE
    ...
    /**
     * @return \Platform\Core\Model\ProfileValueStringTable
     */
    public function table(){
        return \App::table('platform_core_profile_value_string');
    }
    //END_TABLE_GENERATOR
}