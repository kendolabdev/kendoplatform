...
namespace Platform\Place\Model;
...
class PlaceTable extends DbTable
{
	...
	/**
	 * @see `picaso_platform_place`
	 * @var string
	 */
	protected $class = '\Platform\Place\Model\Place';

	/**
	 * @var string
	 */
	protected $name = 'platform_place';
