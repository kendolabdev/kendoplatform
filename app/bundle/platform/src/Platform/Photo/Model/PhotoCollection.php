...
/**
 * Class Platform\PhotoCollection
 *
 * @package Platform\Photo\Model
 */
class PhotoCollection extends Model implements ContentInterface
{
    ...
    /**
     * @return \Platform\Photo\Model\PhotoCollectionTable
     */
    public function table()
    {
        return \App::table('platform_photo_collection');
    }
    //END_TABLE_GENERATOR
}