...
class Manager
{
     ...
     */
    private $hashTypes = [
        'default' => '\Picaso\Auth\DefaultHashGenerator',
    ];
    ...
    /**
     * @param \Picaso\Content\Poster $viewer
     *
     * @throws AuthException
     */
    public function setViewer($viewer)
    {
        if (null != $viewer && !$viewer instanceof Poster) {
    ...
    {
        return null != $this->user ? (int)$this->user->getRoleId() : PICASO_DEFAULT_ROLE_ID;
    }
    ...
    {
        return null != $this->viewer ? (int)$this->viewer->getRoleId() : PICASO_DEFAULT_ROLE_ID;
    }
