...
class ViewHelper
{
    ...
    /**
     * @return \Picaso\Navigation\Manager
     */
    ...
    /**
     * @param \Picaso\Content\Poster|\Picaso\Content\Content $item
     *
     * @return string
     */
