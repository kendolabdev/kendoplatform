...
/**
 * Class PagingSqlSelect
 *
 * @package Picaso\Paging
 */
class PagingSqlSelect implements PagingInterface
{

    /**
     * @var \Picaso\Db\SqlSelect
     */
    protected $data;
    ...
    public function items()
    {
        if (null === $this->itemArray) {
            $this->itemArray = $this->data->limit($this->limit, ($this->page - 1) * $this->limit)->all();
        }
